...
urlpatterns = [
    ...
    url(r'^login/admin/$', auth_view.AdminLogin.as_view()),
    url(r'^admin/dashboard/$', login_required(staff_member_required(admin_view.RestaurantAdmin.as_view(), login_url="/login/admin"), login_url="/login/admin")),
